export default {
  ...
  'pages.table.edit': 'Editar',
  'pages.table.delete': 'Excluir',
  'pages.table.areYouSure': 'Tem certeza?',
  'pages.table.yes': 'Sim',
  'pages.table.no': 'Não',
  'pages.studentTable.id': 'EU IRIA',
  'pages.studentTable.firstName': 'Primeiro nome',
  'pages.studentTable.middleName': 'Nome do meio',
  'pages.studentTable.lastName': 'Último nome',
  'pages.studentTable.address': 'Endereço',
  'pages.studentTable.birthday': 'Aniversário',
  'pages.studentTable.gender': 'Gênero',
  'pages.studentTable.phoneNumber': 'Número de telefone',
  'pages.studentTable.email': 'E-mail',
  'pages.studentTable.editStudent': 'Editar estudante',
  'pages.studentTable.newStudent': 'Novo estudante',
  'pages.studentTable.classrooms': 'Salas de aula',

  'pages.teacherTable.id': 'EU IRIA',
  'pages.teacherTable.firstName': 'Primeiro nome',
  'pages.teacherTable.middleName': 'Nome do meio',
  'pages.teacherTable.lastName': 'Último nome',
  'pages.teacherTable.address': 'Endereço',
  'pages.teacherTable.birthday': 'Aniversário',
  'pages.teacherTable.gender': 'Gênero',
  'pages.teacherTable.phoneNumber': 'Número de telefone',
  'pages.teacherTable.email': 'E-mail',
  'pages.teacherTable.editTeacher': 'Editar Professor',
  'pages.teacherTable.newTeacher': 'Novo professor',
  'pages.teacherTable.classrooms': 'Salas de aula',

  'pages.classroomTable.id': 'EU IRIA',
  'pages.classroomTable.name': 'Nome',
  'pages.classroomTable.code': 'Código',
  'pages.classroomTable.teacher': 'Professora',
  'pages.classroomTable.subject': 'Sujeita',
  'pages.classroomTable.teacherId': 'ID do professor',
  'pages.classroomTable.subjectId': 'ID do assunto',
  'pages.classroomTable.students': 'Alunas',
  'pages.classroomTable.editClassroom': 'Editar sala de aula',
  'pages.classroomTable.newClassroom': 'Nova sala de aula',

  'pages.subjectTable.id': 'EU IRIA',
  'pages.subjectTable.name': 'Nome',
  'pages.subjectTable.code': 'Código',
  'pages.subjectTable.editSubject': 'Editar Assunto',
  'pages.subjectTable.newSubject': 'Novo assunto',
  'pages.subjectTable.classrooms': 'Salas de aula',

  'pages.login.registerAccount': 'Registar Conta',
  'pages.register.success': 'Registre -se bem -sucedido!',
  'pages.register.failure': 'Registro falhou!',
  'pages.login.register': 'Registro',
  'pages.login.login': 'Conecte-se',
  'pages.login.email': 'E-mail',
  'pages.login.password': 'Senha',
  'pages.register.name': 'Nome',
